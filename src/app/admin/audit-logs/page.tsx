  ...
  const columns: ColumnDef<AuditLog>[] = [
    {
      ...
      cell: ({ row }) => (
        <div className="flex items-center space-x-3 py-1 text-[11px] font-black text-[#F0F0FB]/40 tracking-tighter uppercase font-mono">
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="flex items-center space-x-4">
          ...
          <p className="text-[14px] font-black text-[#F0F0FB] tracking-tight leading-none">{row.original.admin}</p>
        </div>
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="flex items-center space-x-4">
          <div className="p-2 rounded-xl bg-primary-blue/10 border border-primary-blue/15 shadow-sm shadow-primary-blue/5">
            <Terminal className="w-4 h-4 text-primary-blue" />
          </div>
          <span className="text-[11px] font-black text-[#F0F0FB] uppercase tracking-widest leading-none">{row.original.action}</span>
        </div>
    ...
    },
    {
      ...
      cell: ({ row }) => <span className="text-[11px] font-black text-[#F0F0FB]/30 uppercase tracking-[0.2em]">{row.original.target}</span>,
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="flex items-center space-x-3 text-[11px] text-[#F0F0FB]/20 font-black font-mono tracking-tighter uppercase">
      ...
      <div className="section-spacing">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
           <div className="p-8 rounded-[32px] bg-[#111827] border border-white/[0.08] flex items-center space-x-6 shadow-premium hover:border-primary-blue/20 transition-all cursor-pointer group">
              <div className="w-16 h-16 rounded-[22px] bg-primary-blue/10 flex items-center justify-center border border-primary-blue/20 shadow-lg shadow-primary-blue/10 group-hover:scale-110 transition-transform duration-500">
              ...
              <div>
                 ...
                 <h4 className="text-3xl font-black text-[#F0F0FB] tracking-tighter mt-1 leading-none">2,482</h4>
              </div>
           </div>
           ...
           <div className="p-8 rounded-[32px] bg-[#111827] border border-white/[0.08] flex items-center space-x-6 shadow-premium hover:border-accent-orange/20 transition-all cursor-pointer group">
              <div className="w-16 h-16 rounded-[22px] bg-accent-orange/10 flex items-center justify-center border border-accent-orange/20 shadow-lg shadow-accent-orange/10 group-hover:scale-110 transition-transform duration-500">
              ...
              <div>
                 ...
                 <h4 className="text-3xl font-black text-[#F0F0FB] tracking-tighter mt-1 leading-none">124</h4>
              </div>
           </div>
           ...
           <div className="p-8 rounded-[32px] bg-[#111827] border border-white/[0.08] flex items-center space-x-6 shadow-premium hover:border-success-green/20 transition-all cursor-pointer group">
              <div className="w-16 h-16 rounded-[22px] bg-success-green/10 flex items-center justify-center border border-success-green/20 shadow-lg shadow-success-green/10 group-hover:scale-110 transition-transform duration-500">
              ...
              <div>
                 ...
                 <h4 className="text-3xl font-black text-[#F0F0FB] tracking-tighter mt-1 leading-none uppercase tracking-tight">Nominal</h4>
              </div>
           </div>
