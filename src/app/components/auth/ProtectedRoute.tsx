  ...
  if (permission && !hasPermission(permission)) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] p-12 text-center">
        ...
        <h2 className="text-2xl font-black text-[#F0F0FB] mb-4 tracking-tight uppercase">Access Restricted</h2>
        <p className="text-[#F0F0FB]/40 max-w-md leading-relaxed font-medium uppercase text-[11px] tracking-widest">
        ...
        <button 
          ...
          className="mt-10 h-12 px-8 rounded-2xl bg-white/[0.02] border border-white/10 text-[#F0F0FB] font-black text-[10px] uppercase tracking-widest hover:bg-white hover:text-black transition-all active:scale-95"
        >
